...
executeBatchSpy('4_geom_revH.py')              			# Defines different parameters
...
executeBatchSpy('6a_elec_circuit_concentric_drive_revB.py')      # Defines different parameters
time_electric_circuit = time.time() - t

executeBatchSpy('6b_bearing_coil_toroidal_revD.py')      # Defines different parameters
time_electric_circuit = time.time() - t

executeBatchSpy('6c_other_outputs_revB.py')      		# Defines different parameters
time_electric_circuit = time.time() - t

executeBatchSpy('7_assign_revE.py')           	    	# Defines different parameters
time_assign = time.time() - t

executeBatchSpy('8_sensors_revD.py')               			# Defines different parameters
