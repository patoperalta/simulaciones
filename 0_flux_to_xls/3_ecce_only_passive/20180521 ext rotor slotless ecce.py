...
# Python will convert \n to os.linesep
f.write('\n')     
n=10 ##counter for value extraction
...
## 2 DALPHA
selectCurrentStep(activeScenario=Scenario['2_DALPHA_3'],
...
#######################################################################################################################
## 3 DBETA
selectCurrentStep(activeScenario=Scenario['3_DBETA_3'],
                  parameterValue=['ALPHA_H='+str(alpha[0]),
                                  'BETA='+str(beta[0]),
                                  'DALPHA=1.5',
								  'DTHETA=45',
