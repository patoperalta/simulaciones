...
## rev I will be done for the stability analysis of ECCE, therefore changing radius... other instances have to be then proportional to it
...
lastInstance = ParameterGeom(name='FIX_AGAP : 1 is constant, 0 is proportional',
              expression='0')			  
...
lastInstance = ParameterGeom(name='D_AGAP : airgap thickness for both cases',
              expression='DEF_AGAP*FIX_AGAP+(1-FIX_AGAP)*K_AGAP*R_ROT_OUT')					  
