...
if ~isempty(varargin)>0 % you set a parameter?
    switch lower(varargin{1})
        ...
        case 'orange'
            lineStyles = whiteFade(N,'orange');return;
        case 'purple'
            lineStyles = whiteFade(N,'purple');return;
        case {'gray','grey'}
...
switch thisColor
    ...
    case 'orange'
        cmapp = [255,245,235;254,230,206;253,208,162;253,174,107;253,141,60;241,105,19;217,72,1;166,54,3;127,39,4];
    case 'purple'
        cmapp = [252,251,253;239,237,245;218,218,235;188,189,220;158,154,200;128,125,186;106,81,163;84,39,143;63,0,125];
    otherwise
