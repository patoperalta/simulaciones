...
Scenario['0_FIELD_R'+str(r_rot)].addPilot(pilot=MultiValues(parameter=VariationParameter['D_AGAP'],
...
Scenario['1_DZ_R'+str(r_rot)].addPilot(pilot=MultiValues(parameter=VariationParameter['D_AGAP'],
                                            intervals=[IntervalStepValue(minValue=dgap_min,
                                                                         maxValue=dgap_max,
                                                                         stepValue=dgap_gap)]))
...
Scenario['2_DALPHA_R'+str(r_rot)].addPilot(pilot=MultiValues(parameter=VariationParameter['D_AGAP'],
                                            intervals=[IntervalStepValue(minValue=dgap_min,
                                                                         maxValue=dgap_max,
                                                                         stepValue=dgap_gap)]))
...
Scenario['3_DBETA_R'+str(r_rot)].addPilot(pilot=MultiValues(parameter=VariationParameter['D_AGAP'],
                                            intervals=[IntervalStepValue(minValue=dgap_min,
                                                                         maxValue=dgap_max,
                                                                         stepValue=dgap_gap)]))
...
Scenario['4_DX_R'+str(r_rot)].addPilot(pilot=MultiValues(parameter=VariationParameter['D_AGAP'],
                                            intervals=[IntervalStepValue(minValue=dgap_min,
                                                                         maxValue=dgap_max,
                                                                         stepValue=dgap_gap)]))
...
Scenario['5_DY_R'+str(r_rot)].addPilot(pilot=MultiValues(parameter=VariationParameter['D_AGAP'],
                                            intervals=[IntervalStepValue(minValue=dgap_min,
                                                                         maxValue=dgap_max,
                                                                         stepValue=dgap_gap)]))
...
Scenario['6_JT_R'+str(r_rot)].addPilot(pilot=MultiValues(parameter=VariationParameter['D_AGAP'],
                                            intervals=[IntervalStepValue(minValue=dgap_min,
                                                                         maxValue=dgap_max,
                                                                         stepValue=dgap_gap)]))
...
Scenario['7_JF_R'+str(r_rot)].addPilot(pilot=MultiValues(parameter=VariationParameter['D_AGAP'],
                                            intervals=[IntervalStepValue(minValue=dgap_min,
                                                                         maxValue=dgap_max,
                                                                         stepValue=dgap_gap)]))
