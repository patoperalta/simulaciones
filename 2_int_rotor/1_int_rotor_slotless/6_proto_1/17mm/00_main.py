...
# executeBatchSpy('4_geom_revC_circular.py')              # Defines different parameters
...
executeBatchSpy('6_elec_circuit_toroidal_revF.py')      # Defines different parameters
...
executeBatchSpy('9_scenarios_characterization.py')      # Defines different parameters
time_scenarios = time.time() - t

executeBatchSpy('10_make_scenarios_sensors.py')         # Defines different parameters
