...
Scenario(name='8_STATOR_OPT')

startMacroTransaction()

Scenario['8_STATOR_OPT'].addPilot(pilot=MultiValues(parameter=VariationParameter['ALPHA_H'],
                                                    intervals=[IntervalStepValue(minValue=1.6,
                                                                                 maxValue=2.0,
                                                                                 stepValue=0.2)]))

Scenario['8_STATOR_OPT'].addPilot(pilot=MultiValues(parameter=VariationParameter['D_ST'],
